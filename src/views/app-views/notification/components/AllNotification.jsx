...
const AllNotification = ({ dataSudah }) => {
  const all = [
    {
    ...
    },
    {
      ...
      deskripsi:
        "Terdapat pertanyaan terbaru dari Fikri Sofia yang belum terjawab",
      waktu: "12 November 2023",
    },
    {
    ...
    <div>
      {all.map((isi, index) => (
        <div
          ...
          style={{ background: "#e9e9e9", borderRadius: "10px" }}
        >
          <button
            id="button"
          ...
          <div className="text grow px-2">
            ...
            <div
              className="subtitle text-gray-400"
              style={{ fontSize: "small" }}
            >
              {isi.deskripsi}
            </div>
          </div>
          <div className="time mx-6 text-sm text-gray-400">{isi.waktu}</div>
          <button className="delete">
            <IoTrash className="text-xl" style={{ fill: "red" }} />
          </button>
        </div>
      ))}
    </div>
