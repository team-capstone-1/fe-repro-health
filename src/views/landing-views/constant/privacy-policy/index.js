...
export const DataPrivacy = [
  {
    ...
    subs: [
      "Informasi yang dikumpulkan saat Anda menggunakan Platform, menerima atau menyediakan Layanan, meliputi:",
    ],
    textContent: [
  ...
  },
  {
    title: "Keamanan Data",
    subs: [
      "Kami mengambil langkah-langkah keamanan teknis dan organisasi yang sesuai untuk melindungi data pribadi Anda dari akses yang tidak sah, penggunaan, atau pengungkapan yang tidak sah. Data sensitif yang dikirimkan melalui website kami akan dienkripsi menggunakan protokol keamanan yang sesuai.",
    ],
    textContent: [],
  },
  {
  ...
  },
  {
    ...
    subs: [
      "Kebijakan privasi ini dapat diperbarui sesuai kebijakan yang berlaku. Setiap perubahan akan diumumkan di website kami. Penggunaan Platform secara berkelanjutan akan menandakan persetujuan dan penerimaan Anda atas perubahan-perubahan tersebut.",
    ],
    textContent: [],
  },
  {
    title: "Kontak",
    subs: [
      "Hukum privasi Indonesia memberikan hak bagi individu untuk mengakses, mengubah, dan menghapus informasi pribadi mereka. Jika Anda ingin mengubah atau menghapus informasi yang kami simpan mengenai Anda, silakan hubungi kami di bawah ini. Dan iika Anda memiliki pertanyaan atau kekhawatiran tentang kebijakan privasi ini, silakan hubungi kami melalui:",
    ],
    textContent: [],
  },
  {
    title: "Reprohealth Customer Care",
    subs: ["Email : support@reprohealth.com", "Nomor Telepon : 0821 3358 1616"],
    textContent: [],
  },
];
